...
export const ERR_NO_BOOKING_FOUND = 465;
export const ERR_ADDRESS_VALIDATION_REQUIRED = 466;
export const ERR_NO_PASS_SELECTED = 467;
...
export const CUSTOM_ERROR_CODES = [
  ...
  ERR_NO_BOOKING_FOUND,
  ERR_ADDRESS_VALIDATION_REQUIRED,
  ERR_NO_PASS_SELECTED,
];
